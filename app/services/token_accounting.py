...
from app.models.workshop_member import WorkshopMember


logger = logging.getLogger("app.services.token_accounting")
...
class TokenAccountingService:
    ...
    def reserve_tokens(
        ...
        # This prevents race conditions by checking again at record time
        return True
