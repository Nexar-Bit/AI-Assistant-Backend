...
# Chat messages
CHAT_WORKSHOP_ID_REQUIRED = "workshop_id y license_plate son requeridos"
CHAT_INVALID_WORKSHOP_ID = "ID de taller inválido"
CHAT_VIEWER_CANNOT_CREATE = "Los visualizadores no pueden crear sesiones de chat. Acceso de solo lectura disponible en historial."
CHAT_INVALID_THREAD_ID = "ID de sesión inválido"
CHAT_THREAD_NOT_FOUND = "Sesión no encontrada"
CHAT_MESSAGE_CONTENT_REQUIRED = "El contenido del mensaje es requerido"
CHAT_OPENAI_NOT_CONFIGURED = "La clave API de OpenAI no está configurada"

# Workshop messages (additional)
WORKSHOP_NOT_MEMBER = "No eres miembro de este taller"
WORKSHOP_REQUIRES_ROLE = "Requiere rol {role} o superior"
WORKSHOP_SLUG_EXISTS = "El slug del taller ya existe"
WORKSHOP_INVALID_ID = "ID de taller inválido"
WORKSHOP_MEMBERSHIP_INACTIVE = "Tu membresía en este taller está inactiva"
WORKSHOP_INVALID_ROLE = "Rol inválido. Debe ser: owner, admin, technician, member, o viewer"
WORKSHOP_CANNOT_CHANGE_OWNER = "No se puede cambiar el rol del propietario"
WORKSHOP_MEMBER_NOT_FOUND = "Miembro no encontrado"
WORKSHOP_USER_NOT_FOUND = "Usuario no encontrado"
WORKSHOP_USER_ALREADY_MEMBER = "El usuario ya es miembro de este taller"
WORKSHOP_CANNOT_REMOVE_OWNER = "No se puede eliminar al propietario del taller"
WORKSHOP_CANNOT_REMOVE_SELF = "No puedes eliminarte a ti mismo del taller"
WORKSHOP_INVALID_COLOR = "El color primario debe ser un color hexadecimal válido (ej: #1A56DB)"
WORKSHOP_ONLY_OWNER_DELETE = "Solo el propietario del taller puede eliminar el taller"
WORKSHOP_INVALID_WORKSHOP_OR_USER_ID = "ID de taller o usuario inválido"

# Reports messages
REPORT_NOT_FOUND = "No encontrado"
REPORT_INVALID_THREAD_ID = "ID de sesión inválido"
REPORT_THREAD_NOT_FOUND = "Sesión no encontrada"
REPORT_PDF_NOT_FOUND = "Archivo PDF no encontrado"

# Vehicle messages
VEHICLE_INVALID_LICENSE_PLATE = "Formato de placa inválido"
VEHICLE_INVALID_WORKSHOP_ID = "ID de taller inválido"
VEHICLE_ALREADY_EXISTS = "Ya existe un vehículo con esta placa en este taller"
...
CONSULTATION_MODIFIED_BY_ANOTHER_PROCESS = "La consulta ha sido modificada por otro proceso"
